  ...
  return (
    <View style={tw`bg-gray-800 rounded-lg overflow-hidden mb-4`}>
      ...
      <RowComponent styles="px-4 py-5 border-b border-gray-600">
        ...
        <RowComponent>
          <Text style={tw`text-base text-orange-400 font-semibold`}>{currentUser.dream.name}</Text>
        </RowComponent>
      </RowComponent>
      ...
      <RowComponent styles="px-4 py-5 border-b border-gray-600">
        ...
        <RowComponent>
          <Text style={tw`text-base text-orange-400 font-semibold`}>{currentUser.dream.price}</Text>
        </RowComponent>
      </RowComponent>
